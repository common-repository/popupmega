...
class Wprp_Default_Popup_Theme extends Wprp_Popup_Theme {
	...
	function render_settings( $popup_id ) {
		...
		include wprp_view_path( 'themes/default/admin_view.php' );
	...
	function theme_style_view( $popup_id, $popup_theme ) {
		...
		include wprp_view_path( 'themes/default/theme_style_admin_view.php' );
	...
	public function auto_popup_render( $popup_id ) {
		...
		include wprp_view_path( 'themes/default/auto_popup.php' );
	...
	function link_popup_render( $popup_id, $shortcode_atts ) {
		...
		include wprp_view_path( 'themes/default/link_popup.php' );
